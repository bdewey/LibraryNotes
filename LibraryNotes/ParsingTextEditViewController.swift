...
extension ParsingTextEditViewController: TextEditViewController {
  public func insertImageData(_ imageData: Data, type: UTType) throws {
    ...
    var rawRange = parsedAttributedString.rawStringRange(forRange: initialRange)
    rawRange.location += markdown.utf16.count
    rawRange.length = 0
    textView.textStorage.replaceCharacters(in: initialRange, with: markdown)
    selectedRange = parsedAttributedString.range(forRawStringRange: rawRange)
  }
}

/// An implementation of ``TextEditViewController`` that parses while you type and drives all formatting from the parsed contents.
public final class ParsingTextEditViewController: UIViewController {
  ...
  public var markdown: String {
    get {
      parsedAttributedString.rawString.text as String
    }
    set {
  ...
  override public func viewDidLoad() {
    ...
    inputBarItems.append(UIBarButtonItem.toggleBoldface)

    inputBarItems.append(UIBarButtonItem.toggleItalics)
...
extension ParsingTextEditViewController: NSTextStorageDelegate {
...
extension ParsingTextEditViewController: UICollectionViewDelegate {
...
extension ParsingTextEditViewController: UITextViewDelegate {
...
private extension ParsingTextEditViewController {
...
extension ParsingTextEditViewController: WebScrapingViewControllerDelegate {
...
extension ParsingTextEditViewController: TextEditingFormattingActions {
  func toggleHeading() {
