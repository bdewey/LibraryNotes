...
NSURL *baseURLForService(DZNPhotoPickerControllerServices service)
{
    switch (service) {
        ...
        case DZNPhotoPickerControllerServiceBingImages:         return [NSURL URLWithString:@"https://api.cognitive.microsoft.com/bing/v7.0/images/search"];
...
NSString *photosResourceKeyPathForService(DZNPhotoPickerControllerServices service)
{
    switch (service) {
        ...
        case DZNPhotoPickerControllerServiceBingImages:         return @"value";
...
NSString *photoSearchUrlPathForService(DZNPhotoPickerControllerServices service)
{
    switch (service) {
        ...
        case DZNPhotoPickerControllerServiceBingImages:         return @"";
...
NSString *keyForSearchTerm(DZNPhotoPickerControllerServices service)
{
    switch (service) {
        ...
        case DZNPhotoPickerControllerServiceBingImages:         return @"q";
