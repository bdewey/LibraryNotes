...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/FlashcardKit/FlashcardKit.bundle"
  install_resource "${PODS_ROOT}/DZNPhotoPickerController/Source/Resources/en.lproj/DZNPhotoPickerController.strings"
  install_resource "${PODS_ROOT}/DZNPhotoPickerController/Source/Resources/en.lproj"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/NunitoSans/NunitoSans.bundle"
fi
